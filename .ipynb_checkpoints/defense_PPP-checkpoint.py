...
def defense_PPP(data):
    ...
    shoot2FGA = data.loc['poa2FGA'].sum().sum()
    shoot2FGM = data.loc['poa2FGM'].sum().sum()
    shoot2FTA = data.loc['poa2FTA'].sum().sum()
    shoot2FTM = data.loc['poa2FTM'].sum().sum()
    shoot2TO = data.loc['poa2TO'].sum().sum()
    shoot2SQ = data.loc['poaSQ2'].sum().sum()
    shoot3FGA = data.loc['poa3FGA'].sum().sum()
    shoot3FGM = data.loc['poa3FGM'].sum().sum()
    shoot3FTA = data.loc['poa3FTA'].sum().sum()
    shoot3FTM = data.loc['poa3FTM'].sum().sum()
    shoot3TO = data.loc['poa3TO'].sum().sum()
    shoot3SQ = data.loc['poaSQ3'].sum().sum()
   
    # Assign passing data to new variables
    pass2FGA = data.loc['help2FGA'].sum().sum()
    pass2FGM = data.loc['help2FGM'].sum().sum()
    pass2FTA = data.loc['help2FTA'].sum().sum()
    pass2FTM = data.loc['help2FTM'].sum().sum()
    pass2TO = data.loc['help2TO'].sum().sum()
    pass2SQ = data.loc['helpSQ2'].sum().sum()
    pass3FGA = data.loc['help3FGA'].sum().sum()
    pass3FGM = data.loc['help3FGM'].sum().sum()
    pass3FTA = data.loc['help3FTA'].sum().sum()
    pass3FTM = data.loc['help3FTM'].sum().sum()
    pass3TO = data.loc['help3TO'].sum().sum()
    pass3SQ = data.loc['helpSQ3'].sum().sum()
    ...
    if shootFGA > 0:
        shoot_FTR = round((shootFTA / shootFGA),2)
    ...
    if passFGA > 0:
        pass_FTR = round((passFTA / passFGA),2)
    ...
    for i, col_dict in col_dicts.items():
        ...
        shoot2FGA = col_dict['poa2FGA']
        shoot2FGM = col_dict['poa2FGM']
        shoot2FTA = col_dict['poa2FTA']
        shoot2FTM = col_dict['poa2FTM']
        shoot2TO = col_dict['poa2TO']
        shoot2SQ = col_dict['poaSQ2']
        shoot3FGA = col_dict['poa3FGA']
        shoot3FGM = col_dict['poa3FGM']
        shoot3FTA = col_dict['poa3FTA']
        shoot3FTM = col_dict['poa3FTM']
        shoot3TO = col_dict['poa3TO']
        shoot3SQ = col_dict['poaSQ3']

        pass2FGA = col_dict['help2FGA']
        pass2FGM = col_dict['help2FGM']
        pass2FTA = col_dict['help2FTA']
        pass2FTM = col_dict['help2FTM']
        pass2TO = col_dict['help2TO']
        pass2SQ = col_dict['helpSQ2']
        pass3FGA = col_dict['help3FGA']
        pass3FGM = col_dict['help3FGM']
        pass3FTA = col_dict['help3FTA']
        pass3FTM = col_dict['help3FTM']
        pass3TO = col_dict['help3TO']
        pass3SQ = col_dict['helpSQ3']
